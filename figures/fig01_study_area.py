...
def build():
    ...
    ax_main.set_xlabel("Longitude (\u00b0)", fontsize=7.5)
    ax_main.set_ylabel("Latitude (\u00b0)", fontsize=7.5)
    ax_main.tick_params(labelsize=6.8)
    ax_main.grid(True, linestyle=":", linewidth=0.3, color="white", alpha=0.45)
    ax_main.set_title(
        "Study area \u2014 Pacaraima (RR, Brazil) \u00b7 ~3,200 km\u00b2 \u00b7 border zone",
    ...
    ax_main.annotate("N",
                     xy=(extent[1] - 0.04, extent[3] - 0.06),
                     xytext=(extent[1] - 0.04, extent[3] - 0.16),
