...
from utils_nato import (FIG_WIDTH_IN, PALETTE, GEOTIFF_DIR, RAW_DIR, class_cmap,
...
TIF_PATHS = {
    "GNN": {
        "a_pe":       resolve_geotiff("a_pe"),
        "motorizada": resolve_geotiff("motorizada"),
        "blindada":   resolve_geotiff("blindada"),
    },
    "Rule": {
