...
ANALISE_DIR = ANALYSIS_DATA_DIR
COLAB_RESULTS_V2 = RESULTS_V2
COLAB_RESULTS_LOCAL = default_gnn_results_dir()
DATA_DIR = ANALYSIS_DATA_DIR
GNN_DIR = DATA_ROOT
RESULTS_DIR = default_gnn_results_dir()
